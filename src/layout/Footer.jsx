...
const Footer = () => {
    return (
        <div className="bg-[#121212] pb-12">
            ...
            <div className="flex flex-row justify-around px-32 pt-10 pb-10 border-b-[1px] border-[#7c7c7c]">
                <div>
                    <p className="text-[#F7B611] text-2xl font-bold pb-4">Company</p>
                ...
                <div>
                <p className="text-[#F7B611] text-2xl font-bold  pb-4">Services</p>
                ...
                <div>
                <p className="text-[#F7B611] text-2xl font-bold  pb-4">Solution</p>
                ...
                <div>
                <p className="text-[#F7B611] text-2xl font-bold  pb-4">Products</p>
                ...
                <div>
                    <p className="text-[#F7B611] text-2xl font-bold  pb-4">Social Media</p>
                    <p className="text-md font-semibold text-[#ffffff] pt-4">Follow Us On Social Media</p>
                    <div className="flex flex-row justify-between space-x-5 pt-6">
                    ...
                    <p className="text-[#ffffff] text-[22px] font-bold pt-7">Business Enquiry: +91 93845 87998</p>
                    <p className="text-[#ffffff] text-[22px] font-bold pt-6">For Job: +91 93614 23585</p>
                </div>
            </div>

            <div className="flex flex-row justify-between px-48 pt-10">
              <div>
                <img src={GiichiLightLogo} alt="" className="" />
                <p className="pt-5 text-[#ffffff] text-md font-semibold">Giichi Solutions & Pvt Ltd  is a software development <br/>
              ...
              <div>
                ...
                <p className="text-[#F7B611] text-3xl font-bold ">Visit Us </p>
                <p className="text-[#F7B611]"><HiHomeModern  size={40}/></p>
                </div>
               
                <p  className="pt-5 text-[#ffffff] text-md font-semibold mr-12">Giichi IT Solution Pvt Ltd <br/> Sushma Infinium, 4/64 <br/> Zirakpur, Gazipur, Punjab, 140603</p>
              </div>
            </div>


            <div className="text-center mt-16 text-[#ffffff] font-medium">Copyright © 2024 Giichi IT Solution & Private Limited. All Rights Reserved.</div>
        </div>
    )
}
