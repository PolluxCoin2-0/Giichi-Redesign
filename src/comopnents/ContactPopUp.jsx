...
const ContactPopUp = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-50 backdrop-blur-sm">
      <div
        className="relative bg-[#ffffff] w-[35%] flex flex-col justify-center items-start text-left p-2"
        style={{
          boxShadow:
      ...
      >
        ...
        <div className="absolute top-[-90px] right-[-80px]">
          <img src={TechImg} alt="" className="w-56" />
        </div>

        <p className="text-3xl font-bold mb-4 px-4 pt-5">Connect With Us</p>
