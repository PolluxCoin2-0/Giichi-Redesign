...
const OpportunitySection = () => {
  ...
  const handleClosePopup2 = () => {
    ...
    return (
        <div className="bg-[#000000] px-4 md:px-32 pt-20 pb-20 flex flex-col md:flex-row justify-between w-full">

            <div className="w-full md:w-[40%]">
                <p className="text-4xl md:text-7xl text-[#ffffff] font-bold leading-tight">WHY CHOOSE <br/> US?</p>
          ...
          <img src={HeroImg} alt="hero-image" className="w-[600px]" />
            ...
            <div className="w-full md:w-[60%]">
                <p className="text-4xl md:text-5xl text-[#ffffff] font-bold leading-tight  ">Maximizing Opportunities for <br/>Businesses with Our Values</p>

                <p className="text-sm md:text-md text-[#a8a5a5] mt-4   ">Maticz is your one-stop solution for all your software development demands and requirements. From concept ideation to <br/>
                ...
                <p className="text-sm md:text-md text-[#a8a5a5] mt-4  ">Our tailored approach ensures that we understand your specific requirements and 
