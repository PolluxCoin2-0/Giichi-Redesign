    ...
    return (
        <div className="bg-[#000000] flex flex-row items-center space-x-12 px-32 pt-20 pb-8">
            ...
            <div>
                ...
                <p  className="text-[#ffffff] text-5xl font-bold leading-tight pt-4">Lorem, ipsum dolor sit amet consectetur <br/> adipisicing elit. Amet perferendis <br/> tempore  culpa.</p>
                ...
                {/* first tech row */}
                <div className="flex flex-row justify-between space-x-8 w-full mt-10">
                    <div className="w-[230px] border-[1px] border-[#968e8e] p-10 pt-3 pb-3 shadow-lg shadow-[#464343] transition-transform transform hover:scale-105">
                 ...
                 {/* Second Tech Row */}
                <div className="flex flex-row justify-between space-x-8 w-full mt-8">
                    <div className="w-[230px] border-[1px] border-[#968e8e] p-10 pt-3 pb-3 shadow-lg shadow-[#464343] transition-transform transform hover:scale-105">
                        <p className="text-[#ffffff] text-lg font-medium text-center ">Frontend</p>
