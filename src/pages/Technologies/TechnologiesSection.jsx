    ...
    return (
        <div className="bg-[#000000] flex flex-col xl:flex-row items-center space-x-0 xl:space-x-12 px-4 md:px-10 lg:px-12 xl:px-32 pt-10 lg:pt-20 pb-8">
            ...
            <div className="w-full">
                ...
                <p  className="text-[#ffffff] text-xl md:text-4xl lg:text-4xl xl:text-5xl font-bold leading-tight pt-4">Huge Spectrum of Next-Gen Technologies Under One Roof </p>
