  ...
  return (
    <div className="text-[#ffffff] bg-[#000000] pt-10  flex flex-col lg:flex-row space-x-0 lg:space-x-12 justify-between ">
      <div className="w-full lg:w-[50%]">
        <p className="text-3xl md:text-5xl lg:text-4xl xl:text-5xl font-bold leading-tight">
      ...
      <div className="w-full lg:w-[50%]">
        ...
        <p className="text-[#ffffff] text-4xl md:text-5xl lg:text-4xl font-semibold pt-8">
          Crypto Wallet
        </p>
