...
const ExchangePage = () => {
    return (
        ...
        <div className="w-[50%]">
          ...
          <p className="text-lg font-normal pt-6">Explore Our Award-winning Products Used by Millions Around the World.</p>
          <img src={NftImg} alt="" className="w-[700px] text-center " />
        </div>

        <div className="w-[50%]">
         <p className="text-[#ffffff] text-3xl font-semibold pt-20">Exchange</p>
         <p className="text-[#ffffff] text-5xl font-semibold pt-8">Crypto Exchange</p>
