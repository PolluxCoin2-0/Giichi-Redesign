    ...
    <div className="text-[#ffffff] bg-[#000000] pt-10 flex flex-col lg:flex-row space-x-0 lg:space-x-12 justify-between ">
      ...
      <div className="w-full lg:w-[50%]">
        ...
        <p className="text-[#ffffff] text-md md:text-lg font-normal pt-8 leading-8">
          ...
          are the pro-players in developing NFT marketplaces on various
          blockchain networks like Ethereum, Binance Chain, Solana, Polygon,
          Avalanche, etc.
        </p>
          ...
          <div>
            ...
            >
              ...
              >
                ...
                <span className="text-xl font-bold text-[#000000] absolute flex items-center justify-center w-full h-full text-purple-500 transition-all duration-400 transform group-hover:translate-x-full ease-out">
                  Get Demo
                </span>
