...
const TokonomicsPage = () => {
  ...
  return (
    <div className="text-[#ffffff] bg-[#000000] pt-10  flex flex-col nd:flex-row space-x-0 md:space-x-12 justify-between ">
      ...
      <div className="w-full md:w-[50%]">
        ...
        <p className="text-[#ffffff] text-4xl md:text-5xl font-semibold pt-8">Tokonomics</p>
