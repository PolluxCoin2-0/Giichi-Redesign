...
const LaunchpadPage = () => {
  ...
  return (
    <div className="text-[#ffffff] bg-[#000000] pt-10  flex flex-col lg:flex-row space-x-0 lg:space-x-12 justify-between ">
      ...
      <div className="w-full lg:w-[50%]">
        <p className="text-[#ffffff] text-2xl md:text-3xl lg:text-2xl xl:text-3xl font-semibold pt-8 xl:pt-20">Launchpad</p>
        <p className="text-[#ffffff] text-4xl md:text-5xl lg:text-4xl xl:text-5xl font-semibold pt-8">Launchpad</p>
