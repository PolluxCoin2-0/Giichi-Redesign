  ...
  return (
    <div className="bg-[#000000] flex flex-col md:flex-row  justify-center px-4 md:px-64 pt-24 pb-32">
      <div>
        ...
        <div
          className="bg-[#121212] mt-5 w-full md:w-[1000px] flex flex-col justify-center items-center text-center pb-10 md:pb-20 border-[1px] border-[#868585] "
          style={{
            boxShadow: '0 2px 20px rgba(0, 0, 0, 0.4), inset 0 0 10px rgba(255, 255, 255, 0.6)', // White shadow with moderate opacity
          }}
        >
          <p className="text-[#ffffff] w-full md:w-[1000px] text-sm md:text-md leading-8 pt-10 md:pt-24 p-2">
          ...
          <p className="mt-2 md:mt-5 bg-[#EBBF0E] rounded-full px-3 py-3 md:px-6 md:py-6">
            <IoPerson size={52} />
          </p>
          <p className="mt-2 md:mt-5 text-[#ffffff] text-lg md:text-xl font-semibold">Durgesh Yadav</p>
      ...
      <div className="bg-[#ffffff] w-full md:w-[20%] relative flex flex-col justify-around items-center mt-6 md:mt-0"> 
      
      <div className="flex flex-row space-x-2 items-center mt-4 md:mt-0">
      <p className="flex justify-center text-[#B62FFD]"><FaAlgolia  size={24}/></p> 
      <p className="text-xl md:text-2xl font-bold pt-2">AUDIOSWIM</p>
      </div>
      ...
      <p className="text-xl md:text-2xl font-bold pt-2 ">L BANK</p>
      </div>

      <div className="flex flex-row space-x-2 items-center mt-4 md:mt-0">
      <p className="flex justify-center text-[#FD7E14]"><FaAccusoft  size={28} /> </p> 
      <p className="text-xl md:text-2xl font-bold pt-2 ">SMART BBN</p>
      </div>

      <div className="flex flex-row space-x-2 items-center mt-4 md:mt-0">
      <p className="flex justify-center text-[#7695FF]"><FaAward  size={28} /> </p>
      <p className="text-xl md:text-2xl font-bold pt-2 ">FINANCIO</p>
      </div>

      <div className="flex flex-row space-x-2 items-center pb-16 md:pb-5 mt-4 md:mt-0">
      <p className="flex justify-center text-[#B62FFD]"><FaBabyCarriage size={28}/> </p>
      <p className="text-xl md:text-2xl font-bold pt-2 ">METAVERSE</p>
      </div>
