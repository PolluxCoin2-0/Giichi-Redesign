        ...
        <div >
            <div className="bg-purple-gradient flex flex-row items-center space-x-56 px-4 md:px-32 pt-20 pb-8">
               ...
               <div>
                ...
                <p className="text-5xl font-bold leading-tight pt-4">We’re More than Just Developers. We Solve <br/>Real-world Problems By Creating Better <br/> Digital Solutions.</p>
