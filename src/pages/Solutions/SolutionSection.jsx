            ...
            <div className="bg-purple-gradient flex flex-col lg:flex-row items-center space-x-0 lg:space-x-12 xl:space-x-56 px-4 md:px-10 lg:px-12 xl:px-32 pt-20 pb-8">
               ...
               <div>
                ...
                <div className="flex flex-col md:flex-row justify-between mt-4">
                    ...
                    <div className="bg-[#000000] text-[#ffffff] w-full md:w-[32%] truncate mt-4 md:mt-0 p-4  text-center  text-lg font-semibold rounded-md shadow-xl transition-transform transform hover:scale-105">IT Service Management</div>
                </div>
