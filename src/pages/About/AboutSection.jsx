...
const AboutSection = () => {
  return (
    <div className="px-4 md:px-10 lg:px-32 relative -mb-20 md:mb-0">
      <div className=" flex flex-col md:flex-col lg:flex-row justify-between items-start md:items-center mt-10 w-full">
        <div className=" w-full lg:w-[40%] ">
          ...
          <p className=" block md:hidden lg:block text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mt-4 md:mt-8 ">
            Software Development <br /> Company
          </p>

          <p className="hidden md:block lg:hidden text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mt-4 md:mt-8 ">
      ...
      <div className="lg:border-2  md:mt-48 lg:-mt-32"></div>
      <div className="relative md:absolute md:-bottom-36 lg:-bottom-16 md:left-0 flex justify-center md:justify-end w-full px-0 md:px-10 lg:px-32 mt-10 md:mt-0">
  <div className="bg-[#569F42] flex flex-col md:flex-row justify-between p-6 w-full lg:w-[80%] rounded-tr-xl rounded-tl-xl rounded-bl-xl rounded-br-[60px]">
